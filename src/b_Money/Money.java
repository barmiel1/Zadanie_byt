...
public class Money implements Comparable {
	...
	{
		return (amount / 100.f) + " " + currency.getName();
	}
	...
	{
		return (int)currency.universalValue(amount);
	}
	...
	{
		return (amount == currency.valueInThisCurrency(other.getAmount(), other.currency));
	}
	...
	{
		int added = amount + currency.valueInThisCurrency(other.getAmount(), other.currency);
	...
	{
		int subtracted = amount - currency.valueInThisCurrency(other.getAmount(), other.currency);
		return new Money(subtracted, currency);
	}
	...
	public int compareTo(Object other)
	{
		...
		int otherValue = currency.valueInThisCurrency(otherMoney.getAmount(), otherMoney.currency);

		int difference = amount - otherValue;
