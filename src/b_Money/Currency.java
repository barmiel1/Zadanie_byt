...
public class Currency {
	 ...
	 */
	public double universalValue(int amount)
	{
		return amount * rate;
	}
	...
	*/
	...
	{
		double otherInUniversal = othercurrency.universalValue(amount);
		return (int)(otherInUniversal / this.rate);	//zamiana odwrotna do konwersji na wartosc uniwersalna
	}
}
